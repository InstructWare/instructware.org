...
## Common Actions
- `action.read`: Read
- `action.open_docs_center`: Open Docs Center
- `action.read_manifesto`: Read Manifesto
- `action.read_protocol`: Read Protocol
- `action.view_on_github`: View on GitHub

## Docs
- `docs.title`: Documentation Center
- `docs.progress`: Reading Progress

## Home
- `home.hero.title`: Beyond Static Software
